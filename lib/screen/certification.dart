            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  label: Text('course name',style: TextStyle(color: Colors.black54,fontSize: 20,fontWeight: FontWeight.bold),),
                  hintText: 'Enter your course name here ',
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  filled: true,
                  fillColor: const Color(0xffECECEC),
                  label: Text('Certificate link',style: TextStyle(color: Colors.black54,fontSize: 20,fontWeight: FontWeight.bold),),
